...
// PWA
// -----------------------------------------------------------------------------
const cacheName = "app-" + "c16923cb7e73592766d1c28540d72f39f450eece";
const resourcesToCache = ["https://unpkg.com/spectre.css/dist/spectre.min.css","https://raw.githubusercontent.com/maxence-charriere/go-app/master/docs/web/icon.png","/wasm_exec.js","/manifest.webmanifest","/app.js","/app.css","/","./web/app.wasm"];

self.addEventListener("install", async (event) => {
  try {
    console.log("installing app worker c16923cb7e73592766d1c28540d72f39f450eece");
    await installWorker();
...
self.addEventListener("activate", async (event) => {
  try {
    ...
    console.log("app worker c16923cb7e73592766d1c28540d72f39f450eece is activated");
  } catch (error) {
